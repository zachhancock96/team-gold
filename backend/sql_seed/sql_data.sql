...
INSERT INTO USER (id, email, password, name, role) VALUES
  (1, 'admin@test.net', 'admin', 'Admin', 'admin'),
  (2, 'assignor@test.net', 'assignor', 'Assignor', 'assignor'),
  (3, 'schooladmin@test.net', 'schooladmin', 'School Admin', 'school_admin'),
  (4, 'schoolrepa@test.net', 'schoolrep', 'School Representative A', 'school_rep'),
  (5, 'schoolrepb@test.net', 'schoolrep', 'School Representative B', 'school_rep'),
  (6, 'schoolrepc@test.net', 'schoolrep', 'School Representative C', 'school_rep');
...
INSERT INTO GAME (id, homeTeamId, awayTeamId, start, location, status, rejectionNote) VALUES
  (1, 1, 3, '2020-03-15T18:00:00-05:00', 'WOHS', 'approved_unlocked', null),
  (2, 3, 4, '2020-03-16T18:00:00-05:00', 'WMHS', 'approved_unlocked', null);